...
(function () {
    ...
    var g = {VERSION: "1.5.7", STOPPED: 1, STARTED: 2, QUEUED: 1, UPLOADING: 2, FAILED: 4, DONE: 5, GENERIC_ERROR: -100, HTTP_ERROR: -200, IO_ERROR: -300, SECURITY_ERROR: -400, INIT_ERROR: -500, FILE_SIZE_ERROR: -600, FILE_EXTENSION_ERROR: -601, IMAGE_FORMAT_ERROR: -700, IMAGE_MEMORY_ERROR: -701, IMAGE_DIMENSIONS_ERROR: -702, mimeTypes: j, ua: (function () {
        ...
        if (o > 1073741824) {
            if(parseInt(o / 1073741824) == (o / 1073741824).toFixed(1)){
                return parseInt(o / 1073741824) + " GB"
            }else if((o / 1073741824).toFixed(1) == (o / 1073741824).toFixed(2)){
                return (o / 1073741824).toFixed(1) + ' GB'
            }else{
                return (o / 1073741824).toFixed(2) + " GB"
            }
        }
        if (o > 1048576) {
            return parseInt(o / 1048576) + " MB"
        }
        if (o > 1024) {
            return parseInt(o / 1024) + " KB"
        }
        return o + " b"
    }, getPos: function (p, t) {
